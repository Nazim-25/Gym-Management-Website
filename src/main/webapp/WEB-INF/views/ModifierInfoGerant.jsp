...
<body>
 ...
 <div class="container">
  ...
  <form:form action="/SaveGerant" method="post" modelAttribute="gerant" class="firm">
   <h1>Formulaire de modification de gerant</h1>
  
		 	<% 
			            if( session.getAttribute("EmailGerantExiste")!= null ){
                 out.println("<div class='container'>");
                 	   out.println(" <div  class='alert alert-danger my-2 text-center' role='alert' >");
			            out.println( session.getAttribute("EmailGerantExiste") );
				       out.println("</div>");
				out.println("</div>");
			            } %>
   ...
   <div >
   <a href="ChangePasswordGerant"  class="link-primary">changer le mot de passe</a>
   </div>
