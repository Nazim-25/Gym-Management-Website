...
<link rel="stylesheet" type="text/css" href=" /css/bootstrap.min.css"/>
	<link rel="stylesheet" type="text/css" href=" /css/modifierinfogerant.css"/>
...
<body>
 ...
 <div class="container">
  ...
  <form:form action="/SaveNewGerantPassword" method="post" modelAttribute="Mdp" class="firm">
   <h1>Modifiez votre mot de passe  </h1>
   	 <% 
			            if( session.getAttribute("NewGerantMdpWrong")!= null ){
                 out.println("<div class='container'>");
                 	   out.println(" <div  class='alert alert-danger my-2 text-center' role='alert' >");
			            out.println( session.getAttribute("NewGerantMdpWrong") );
				       out.println("</div>");
				out.println("</div>");}
 			 %>
			            
			    	 <% 
			            if( session.getAttribute("PasswordGerantWrong")!= null ){
                 out.println("<div class='container'>");
                 	   out.println(" <div  class='alert alert-danger my-2 text-center' role='alert' >");
			            out.println( session.getAttribute("PasswordGerantWrong") );
				       out.println("</div>");
				out.println("</div>");
			            } %>
   ...
   <a href="mdpOublierGerant">Mot de passe oublié</a>
  </form:form>
  
 </div>

 <% session.removeAttribute("PasswordGerantWrong"); %>
	<% session.removeAttribute("NewGerantMdpWrong"); %>
