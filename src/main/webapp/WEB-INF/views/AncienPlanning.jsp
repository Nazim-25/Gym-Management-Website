...
<%LocalDate today=(LocalDate)session.getAttribute("DateDebut");  LocalDate todayplus1=today.plusDays(1);  LocalDate todayplus2=today.plusDays(2);%>
...
<%	List<Seance> ListSeances=(List<Seance>)session.getAttribute("listSeances2"); %>
 <div class="nav_bar">
         <ul>
